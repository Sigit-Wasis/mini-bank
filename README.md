...
| | (Mengelola UI, State, dan User Interaction) | |
| +--------------------------+--------------------------+ |
+-----------------------------|-----------------------------+
|
| HTTPS Request (JSON / Axios)
v
+-----------------------------------------------------------+
| BACKEND LAYER |
| +-----------------------------------------------------+ |
...
| |
+----------------v---------+ +-----------v------------+
| DATA LAYER (SQL) | | STORAGE LAYER (S3) |
| | | |
| PostgreSQL | | MinIO |
| (User Data, Metadata, | | (Images, Files, |
| Relations) | | Documents) |
+-------------------------+ +------------------------+
